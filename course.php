    ...
    <section class="course">
        ...
        <div class="row">
            <div class="course-col">
                <h3>Intermediate</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae error totam voluptatum pariatur, rem doloremque illo mollitia necessitatibus repellat repellendus eum iure qui.</p>
            </div>
            <div class="course-col">
                <h3>Degree</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae error totam voluptatum pariatur, rem doloremque illo mollitia necessitatibus repellat repellendus eum iure qui.</p>
    ...
    <section class="Facilities">
        ...
        <div class="row">
            <div class="Facilities-col">
                <img src="assets/image/library.png" alt="">
                <h3>World Class Library</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae error totam voluptatum pariatur, rem doloremque illo mollitia necessitatibus repellat repellendus eum iure qui.</p>
            </div>
            <div class="Facilities-col">
                <img src="assets/image/basketball.png" alt="">
                <h3>Largest Play Ground</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae error totam voluptatum pariatur, rem doloremque illo mollitia necessitatibus repellat repellendus eum iure qui.</p>
            </div>
            <div class="Facilities-col">
                <img src="assets/image/cafeteria.png" alt="">
